...
func main() {
   ...
   // Works in query :  select COUNT(*) from VM17_SBM_AE_OE_REPO_CL.dbo.ts_tables

   // sqlserver://sa:mypass@localhost?database=master&connection+timeout=30 // username=sa, password=mypass.
   // sqlserver://sa:mypass@localhost:1234?database=master&connection+timeout=30" // port 1234 on localhost.
   const server = "VM17"
   const server_port = "1433"
   const instance = "VM17_SQLSERVER"

   const DB = "VM17_SBM_AE_OE_REPO_CL"
   const schema = "dbo"

   // Using SA doesn't make any difference
   // const userid = "VM17_SBM"
   const userid = "SA"
   // const pwd = "P@55word"
   const pwd = "P4$$w0rd"
   ...
   // Unable to get instances from Sql Server Browser on host VM17: read udp 192.168.91.1:49332->192.168.91.135:1434: i/o timeout
